 ...
 */
function ip_master_display_scaffolding_section( $args = array() ) {
	...
	$allowed_tags = ip_master_scaffolding_allowed_html();
	...
	<div class="scaffolding-document accordion <?php echo esc_attr( $class ); ?>">
		...
		<div class="accordion-item">
			...
			<header class="scaffolding-document-header display-flex flex-start space-between accordion-item-header">
				...
				<button type="button" class="scaffolding-button"><?php esc_html_e( 'Details', 'ip_master' ); ?></button>
			...
			<div class="scaffolding-document-content accordion-item-content">
				...
				<?php if ( $args['description'] ) : ?>
					<p><strong><?php esc_html_e( 'Description', 'ip_master' ); ?>:</strong></p>
					<p class="scaffolding-document-description"><?php echo esc_html( $args['description'] ); ?></p>
				<?php endif; ?>

				<?php if ( $args['parameters'] ) : ?>
					<p><strong><?php esc_html_e( 'Parameters', 'ip_master' ); ?>:</strong></p>
				...
				<?php if ( $args['arguments'] ) : ?>
					<p><strong><?php esc_html_e( 'Arguments', 'ip_master' ); ?>:</strong></p>
				...
				<?php if ( $args['usage'] ) : ?>
					<p><strong><?php esc_html_e( 'Usage', 'ip_master' ); ?>:</strong></p>
					<pre><?php echo esc_html( $args['usage'] ); ?></pre>
				<?php endif; ?>

				<?php if ( $args['output'] ) : ?>
					<p><strong><?php esc_html_e( 'HTML Output', 'ip_master' ); ?>:</strong></p>
 ...
 * @author Carrie Forde
 */
function ip_master_scaffolding_allowed_html() {
 ...
 * @author Carrie Forde
 */
function ip_master_display_global_scaffolding_section( $args = array() ) {
 ...
 * @author Carrie Forde
 */
function ip_master_hook_theme_scaffolding() {
...
add_action( 'ip_master_scaffolding_content', 'ip_master_hook_theme_scaffolding' );
