...
function ip_master_get_theme_colors() {
	return array(
		esc_html__( 'Alto', 'ip_master' )           => '#ddd',
		esc_html__( 'Black', 'ip_master' )          => '#000',
		esc_html__( 'Blue', 'ip_master' )           => '#21759b',
		esc_html__( 'Cod Gray', 'ip_master' )       => '#111',
		esc_html__( 'Dove Gray', 'ip_master' )      => '#666',
		esc_html__( 'Gallery', 'ip_master' )        => '#eee',
		esc_html__( 'Gray', 'ip_master' )           => '#808080',
		esc_html__( 'Gray Alt', 'ip_master' )       => '#929292',
		esc_html__( 'Light Yellow', 'ip_master' )   => '#fff9c0',
		esc_html__( 'Mineshaft', 'ip_master' )      => '#333',
		esc_html__( 'Silver', 'ip_master' )         => '#ccc',
		esc_html__( 'Silver Chalice', 'ip_master' ) => '#aaa',
		esc_html__( 'White', 'ip_master' )          => '#fff',
		esc_html__( 'Whitesmoke', 'ip_master' )     => '#f1f1f1',
	);
}
